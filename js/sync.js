...
(() => {
  ...
  const SYNC_KEYS = ["menus", "notices", "schedules", "levelHistory", "pwOverrides", "userOverrides", "customUsers", "gcal", "inspections", "contacts", "branches", "passes", "passOwners", "equipment", "equipMaint", "trainings", "contracts", "regulations", "policy", "certs", "certOpts", "billing", "vault", "kpis", "council", "cars", "carCfg", "supervisors", "stationOfficers"];
