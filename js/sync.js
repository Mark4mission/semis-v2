...
(() => {
  ...
  const SYNC_KEYS = ["menus", "notices", "schedules", "levelHistory", "pwOverrides", "userOverrides", "customUsers", "gcal", "inspections", "contacts", "branches", "passes", "equipment", "equipMaint", "trainings", "contracts", "vault"];
