...
(() => {
  ...
  const SYNC_KEYS = ["menus", "notices", "schedules", "levelHistory", "pwOverrides", "customUsers", "gcal", "inspections", "contacts", "branches", "passes", "equipment", "trainings", "contracts", "vault"];
